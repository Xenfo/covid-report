              ...
              <div className="flex max-h-80 justify-center overflow-y-scroll scrollbar scrollbar-thin scrollbar-track-gray-300 scrollbar-thumb-gray-700">
                <div className="text-md mt-4 mr-2 text-gray-700 md:mr-1">
                  ...
                  <p className="mt-2">
                    ...
                    ID and your child tests positive again after 5 days, report
                    the case using the case ID.
                  </p>
                  <p className="mt-2">
                    We are counting on your honesty in submitting cases, because
                    we have no means to validate whether a case is real. The
                    tool imposes a limit to the number of cases than can be
                    entered over a 10-day period.
                  </p>
                  <p className="mt-2">
                    If you wish to have your school added to the tracker or if
                    you find any bugs, please send an email to:{' '}
                    <a
